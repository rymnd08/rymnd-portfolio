...
const Skills  = () => {
    const skills: ISkills[] = [
        ...
        {id: 8, name: 'HTML', imgURL: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/HTML5_Badge.svg/800px-HTML5_Badge.svg.png'},
        {id: 9, name: 'CSS', imgURL: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/CSS3_logo.svg/800px-CSS3_logo.svg.png'},
        {id: 10, name: 'Git', imgURL: 'https://git-scm.com/images/logos/downloads/Git-Icon-1788C.png'},
        {id: 11, name: 'GitHub', imgURL: 'https://cdn-icons-png.flaticon.com/512/25/25231.png'},
    ]
