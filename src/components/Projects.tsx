...
const Projects = () => {
    ...
    const projects = [
        ...
        {id: 6, title: 'Create personal portfolio using react', url: '/portfolio.PNG', github: 'https://github.com/rymnd08/rymnd-portfolio', live: 'https://rymnd-portfolio.web.app'},
    ]

    return ( 
        <div className="div grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-content-center place-items-center mt-6 gap-10">
