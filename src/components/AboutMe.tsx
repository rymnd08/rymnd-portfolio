    ...
    return ( 
        <div className="min-h-screen border border-transparent mb-[200px] lg:mb-[100px] px-4 lg:px-0" id="about-me">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 place-items-center lg:place-items-start place-content-center min-h-[75vh] gap-20">
                ...
                <div className="rounded p-4 border hover:scale-110 hover:text-white transition ease duration-200">
                    <h3 className="mb-4 font-bold md:text-lg lg:text-xl">Resume</h3>
                    <img src="/resume.PNG" alt="" className="h-[200px] rounded mb-3 "  />
                    <div className="flex justify-between rounded text-center">
                        <a href="/rymnd_resume2023.pdf" target="_blank" className="py-1 px-3 bg-blue-500 w-full">View</a>
                        <a href="/rymnd_resume2023.pdf" download="raymund_regalado_resume.pdf" className="py-1 px-3 bg-slate-500 w-full">Download</a>
                    </div>
                </div>

                <div className="rounded p-4 border hover:scale-110 hover:text-white transition ease duration-200">
                    <h3 className="mb-4 font-bold md:text-lg lg:text-xl">GitHub</h3>
                    <img src="https://github.githubassets.com/assets/GitHub-Mark-ea2971cee799.png" alt="GitHub logo" className="h-[200px] rounded mb-3 "  />
                    <a href="https://github.com/rymnd08" target="_blank" className="py-1 px-3 bg-blue-500 block text-center">View</a>
                </div>

                <div className="md:flex gap-4 items-center hover:scale-110 hover:text-white transition ease duration-200 p-4">
                    ...
                    <h3 className=" md:text-lg lg:text-xl font-semibold ">raymundregalado8@gmail.com</h3>
                </div>
                ...
                <div className="md:flex gap-4 items-center hover:scale-110 hover:text-white transition ease duration-200 p-4">
                    ...
                    <h3 className=" md:text-lg lg:text-xl font-semibold  underline">
